    ...
    <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-end justify-content-start">
            <div class="col-md-9 ftco-animate pb-5">
                <p class="breadcrumbs"><span class="mr-2"><a href="/home">Home <i class="ion-ios-arrow-forward"></i></a></span> <span class="mr-2"><a href="/blog">Blog <i class="ion-ios-arrow-forward"></i></a></span> <span>Blog Single <i class="ion-ios-arrow-forward"></i></span></p>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-8 ftco-animate">
                ...
                <p>
                    <img src="/assets/front/images/image_7.jpg" alt="" class="img-fluid">
                </p>
                ...
                <p>
                    <img src="/assets/front/images/image_8.jpg" alt="" class="img-fluid">
                </p>
                ...
                <div class="about-author d-flex p-4 bg-light">
                    <div class="bio mr-5">
                        <img src="/assets/front/images/person_1.jpg" alt="Image placeholder" class="img-fluid mb-4">
                    </div>
                    <div class="desc">
            ...
            <div class="col-md-4 sidebar ftco-animate">
                ...
                <div class="sidebar-box ftco-animate">
                    ...
                    <div class="block-21 mb-4 d-flex">
                        <a class="blog-img mr-4" style="background-image: url(/assets/front/images/image_3.jpg);"></a>
                        <div class="text">
                            <h3 class="heading"><a href="#">Why Lead Generation is Key for Business Growth</a></h3>
                            <div class="meta">
                                <div><a href="#"><span class="icon-calendar"></span>Oct. 29, 2019</a></div>
