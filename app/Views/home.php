                ...
                <div class="carousel-car owl-carousel">
                    ...
                    <div class="item">
                        <div class="car-wrap rounded ftco-animate">
                            ...
                            <div class="text">
                                <h2 class="mb-0"><a href="#"><?= htmlspecialchars($car['brand']); ?></a></h2>
                                <div class="d-flex mb-3">
                                    <span class="cat"><?= htmlspecialchars($car['model']); ?></span>
...
<section class="ftco-section ftco-about">
    <div class="container">
        <div class="row no-gutters">
            <div class="col-md-6 p-md-5 img img-2 d-flex justify-content-center align-items-center" style="background-image: url(/assets/front/s/about.jpg);">
            </div>
        ...
        <div class="row d-flex">
            <div class="col-md-4 d-flex ftco-animate">
                <div class="blog-entry justify-content-end">
                    <a href="/blog-single" class="block-20" style="background-image: url('/assets/front/images/image_1.jpg');">
                    </a>
                    <div class="text pt-4">
                        <div class="meta mb-3">
            ...
            <div class="col-md-4 d-flex ftco-animate">
                <div class="blog-entry justify-content-end">
                    <a href="/blog" class="block-20" style="background-image: url('/assets/front/images/image_2.jpg');">
                    </a>
                    <div class="text pt-4">
                        <div class="meta mb-3">
                            <div><a href="#">Oct. 29, 2019</a></div>
            ...
            <div class="col-md-4 d-flex ftco-animate">
                <div class="blog-entry">
                    <a href="/blog" class="block-20" style="background-image: url('/assets/front/images/image_3.jpg');">
                    </a>
                    <div class="text pt-4">
                        <div class="meta mb-3">
                            <div><a href="#">Oct. 29, 2019</a></div>
